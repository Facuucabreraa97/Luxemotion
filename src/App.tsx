...
const MobileNav = () => {
    ...
    return (
        <div className="lg:hidden fixed bottom-0 w-full bg-[#0a0a0a] border-t border-white/10 flex justify-around p-2 pb-6 z-50">
            ...
            <NavLink to="/app/earnings" className={({ isActive }) => `p-3 flex flex-col items-center gap-1 ${isActive ? 'text-[#C6A649]' : 'text-white/50'}`}><DollarSign size={20} /><span className="text-[8px] uppercase font-bold">{t('common.nav.earnings')}</span></NavLink>
...
// Local LandingPage removed to use imported version from ./pages/LandingPage
    ...
    return (
        <div className="fixed inset-0 bg-black flex items-center justify-center z-[100]">
            ...
            <div className={`relative z-10 w-full max-w-xs p-10 rounded-[40px] text-center ${S.panel}`}>
                <div className="mb-10">
                    <img src="/branding/logo-white.png" alt="MivideoAI" className="h-12 w-auto mx-auto mb-2 object-contain" />
                    <p className={S.subLuxe}>PRO</p>
                </div>
