...
const ProtectedLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    if (loading) return <div className="h-screen bg-[#050505] flex items-center justify-center"><div className="w-8 h-8 border-2 border-[#D4AF37] border-t-transparent rounded-full animate-spin" /></div>;
    ...
    return (
        <div className="flex h-screen bg-[#050505] overflow-hidden text-white font-sans">
            ...
            <div className="flex-1 flex flex-col h-full relative">
                <MobileHeader />
                <main className="flex-1 overflow-y-auto overflow-x-hidden relative w-full scrollbar-hide">
                    {children}
                </main>
                <MobileNav />
            </div>
