...
export default function Sidebar() {
  ...
  return (
    <div className="hidden lg:flex flex-col w-[280px] h-full bg-[#050505] border-r border-white/5 p-6">
      <div className="mb-12 flex items-center gap-3"><div className="w-8 h-8 bg-[#D4AF37] rounded flex items-center justify-center font-bold text-black">L</div><span className="font-bold tracking-widest">LUXEMOTION</span></div>
