...
const Profile = () => {
    const [activeTab, setActiveTab] = useState<'created' | 'drafts' | 'collected' | 'wallet'>('created');
                ...
                <div className="mt-8">
                    {loading ? (
                        ...
                        <div className="glass-panel rounded-2xl overflow-hidden p-6 border border-white/10">
                            <h3 className="text-xl font-display font-medium mb-6 text-white">Transaction History</h3>
