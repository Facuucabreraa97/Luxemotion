            ...
            <header className="mb-10 flex justify-between items-center border-b border-white/10 pb-6">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
                        VYDY OPS
                        <span className="bg-yellow-400 text-black text-xs px-2 py-1 rounded font-bold">v3.0 [EXILE RELESE]</span>
                    </h1>
                ...
                {TABS.map((tab) => (
                    <button
                        ...
                        className={`pb-4 flex items-center gap-2 text-sm font-bold tracking-widest transition-all ${activeTab === tab.id
                            ? 'text-yellow-400 border-b-2 border-yellow-400 shadow-[0_4px_20px_-10px_rgba(250,204,21,0.5)]'
