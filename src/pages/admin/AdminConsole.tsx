...
export default function AdminConsole() {
    ...
    const TABS = [
        ...
        { id: 'sentinel', label: 'SENTINEL AI', icon: Zap, component: <SentinelConsole />, highlight: true }
    ];
    ...
    return (
        <div className="min-h-screen bg-black text-white p-8 font-sans">
            <header className="mb-10 flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white mb-2">VYDY OPS <span className="text-zinc-600 text-sm ml-2">v2.0</span></h1>
