export const S = {
  ...
  btnVelvet: "bg-gradient-to-r from-[#0a0a0a] via-zinc-900 to-[#0a0a0a] text-[#C6A649] font-bold uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(198,166,73,0.15)] hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(198,166,73,0.3)] active:scale-95 transition-all duration-300 border border-[#C6A649]/30 rounded-xl cursor-pointer",
